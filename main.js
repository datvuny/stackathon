...
class FirstPersonCameraDemo {
  ...
  initializeAudio_() {
    ...
    loader.load('resources/music/daft.mp3', (buffer) => {
      setTimeout(() => {
    ...
    loader.load('resources/music/world.mp3', (buffer) => {
      setTimeout(() => {
  ...
  initializeScene_() {
    ...
    // this._mixers = [];
      ...
      //     './resources/dancer/', 'mouse.fbx', new THREE.Vector3(0, -1.5, 5));
      // this._LoadAnimatedModelAndPlay(
      //     './resources/mouse/', 'TPose.fbx', 'Dancing.fbx', new THREE.Vector3(12, 0, -10));
      // this._LoadAnimatedModelAndPlay(
  ...
  //   loader.load('./resources/mouse/scene.gltf', (gltf) => {
